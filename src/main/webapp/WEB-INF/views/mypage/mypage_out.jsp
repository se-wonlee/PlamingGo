    ...
    <section id="subscribe">
      <div class="container wow fadeInUp">
        <div class="section-header" style="padding-top: 220px; ">
          ...
          <h2>회원탈퇴</h2>
          <p>안전한 탈퇴를 위해, <strong>PLAMINGGO</strong> 아이디와 비밀번호를 입력해주세요. <br />
          확인후 해당 계정은  <a href="#">완전 삭제</a> 됩니다.</p>
        </div>
        

        <form method="post" action="out_check">
          <div class="form-row justify-content-center"  >
            <div class="col-auto">
              <input type="text" class="form-control" value="${id }" placeholder="Enter your Email" name="login_id" readonly="readonly">
                <c:if test="${log eq 2}">
              <p style="color: red; margin-left: 10px;"><strong>존재하지 않는 아이디입니다.</strong></p>
              </c:if>
              
              <input type="password" class="form-control" placeholder="Enter your Pass" name="login_pw">
              <c:if test="${log eq 0}">
              <p style="color: red; margin-left: 10px;"><strong>비밀번호가 일치하지 않습니다.</strong></p>
              </c:if>
              
             
              <button type="submit" style="width: 100%; margin: 10px;" > 확인 </button><br />
