...
<script type="text/javascript"
	src='<c:url value="/resources/js/jquery-3.4.1.min.js"></c:url>'></script>
...
<body>
	...
	<header id="header">
		<div class="container">
			<div id="logo" class="pull-left">
				...
				<h1>
					<a href="../PlamingGo">Pla<span>ming</span>Go
					</a>
				</h1>
			...
			<nav id="nav-menu-container">
				<ul class="nav-menu">
					<li>
						<!-- 검색 처리 : form 태그 추가 --> <!-- 검색창 검색 결과 후, search 페이지로 이동 -->
						<form action="../search" method="get" id="form1" name="form1">
							<input type="hidden" name="page" id="page" value="" />
							<div class="box">
								<div class="container-4">
									<input type="search" id="search" name="searchKeyword"
										placeholder="제목, 배우, 감독 검색 " value="${searchKeyword }" />
	...
	<main id="main">
		...
		============================-->
		<!-- 뒤로가기 아이콘 -->
		<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: #f82249">
			<a href="movie"> <i class="fa fa-arrow-left fa-lg"></i> <!-- 33% 크기 -->
		</a>
		</span> <br />
		<br />
		...
		<section id="speakers-details" class="wow fadeIn">
			...
			<form action="movie_insert_page" method="post"
				...
				<div class="container">
					...
					<button type="button" class="btn btn-outline-danger"
						data-toggle="modal" data-target="#exampleModal">등록</button>
					...
					<!-- 취소 버튼-->
					<a class="btn btn-outline-danger" href="movie" role="button">취소</a>
					<hr />
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="details">
								<!-- 제목(TITLE)-->
								<h2>
									<input type="text" name="movie_title" size="30" placeholder="제목"
										required autofocus />
								</h2>
								...
								<dl class="row">
									...
									<dd class="col-sm-9">
										<input type="text" name="movie_time" size="30" placeholder="평점"
											required />
									</dd>

									<dt class="col-sm-3">제작년도</dt>
									<dd class="col-sm-9">
										<input type="text" name="movie_date" size="30"
											placeholder="제작년도" required />
									</dd>
									...
									<dd class="col-sm-9">
										...
										<input type="text" name="movie_age" size="10" placeholder="시청연령대" required/>
										&nbsp;/&nbsp; 
										<!-- <input type="text" name="epi" size="10"
											placeholder="에피소드" required />개 -->
									</dd>

									<dt class="col-sm-3">감독</dt>
									<dd class="col-sm-9">
										<input type="text" name="movie_director" size="30"
											placeholder="감독" required />
									</dd>

									<dt class="col-sm-3">배우</dt>
									<dd class="col-sm-9">
										<input type="text" name="movie_actor" size="30"
											placeholder="배우" required />
									</dd>

									<dt class="col-sm-3">장르</dt>
									<dd class="col-sm-9">
										<input type="text" name="movie_genre" size="30"
											placeholder="장르" required />
									</dd>

									<dt class="col-sm-3">줄거리</dt>
									<dd class="col-sm-9">
										<textarea name="movie_summary" cols="38" rows="10"
											placeholder="해당 컨텐츠의 줄거리를 입력하세요." required></textarea>
									</dd>

									<dt class="col-sm-3">트레일러</dt>
									<dd class="col-sm-9">
										<input type="text" name="movie_trailer" size="30"
											placeholder="트레일러 영상 주소" required />
									</dd>
								</dl>
							</div>
						</div>
			...
			<!-- 01. 기본정보 form → insert_page로 보내기 끝 -->
		...
		function setImageFromFile(input, expression) {
		    if (input.files && input.files[0]) {
		        ...
		        reader.onload = function (e) {
		            $(expression).attr('src', e.target.result).width(640).height(480);
		        }
		...
		function setThumbnail(event) {
			for (var image of event.target.files) {
				...
				reader.onload = function (event) {	// 파일 읽어들이기를 성공했을 때 호출되는 이벤트 핸들러
					...
					document.querySelector("div#select_thumbnail1").appendChild(thumbnail);
				};
