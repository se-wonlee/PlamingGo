		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  			...
  			<div class="carousel-inner">
    			<div class="carousel-item active">
      				<a href="../drama_detailview?c=11">
      					<img src="../resources/upload-drama/the-politician.jpg" class="d-block w-100" 
      					alt="First Slide" width="100%">
      				</a>
    			</div>
    			<div class="carousel-item">
      				<a href="../drama_detailview?c=4">
      					<img src="../resources/upload-drama/killing-eve-season32.jpg" class="d-block w-100" 
      					alt="Second Slide" width="100%">
      				</a>
    			</div>
    			<div class="carousel-item">
      				<a href="../drama_detailview?c=15">
      					<img src="../resources/upload-drama/friends1.jpg" class="d-block w-100" 
