...
<!-- 	<img src="https://images.justwatch.com/backdrop/175312447/s1440/kilring-ibeu" 
	...
	<main id="main">
		...
		<form action="insert_page" method="post" enctype="multipart/form-data">
			...
			<div class="container">
				...
				<!-- 취소 버튼-->
				<a class="btn btn-outline-danger" href="../drama" role="button">취소</a>
				<hr />
				...
				<div class="row">
			    	<div class="col-md-6">
						...
						<div class="inputArea">
							...
							<div class="select_img"><img src="" class="img-fluid"/></div>
			        ...
			        <div class="col-md-6">
			            <div class="details">
			            	<!-- 제목(TITLE)-->
			            	<h2>
			            		<input type="text" name="title" size="30" placeholder="제목" required autofocus/>
			            	</h2>
			            
			              	<dl class="row">
			              		<dt class="col-sm-3">평점</dt>
							  	<dd class="col-sm-9"><input type="text" name="rating" size="30" placeholder="평점(숫자만 기입)" required/></dd>
			              		
								<dt class="col-sm-3">제작년도</dt>
							  	<dd class="col-sm-9"><input type="text" name="opendate" size="30" placeholder="제작년도(숫자만 기입)" required/></dd>
								...
								<dt class="col-sm-3">국가</dt>
  								...
  								<dd class="col-sm-9">
  									<select name="age" required>
  										<option value="연령" selected disabled>연령</option>
  									...
  									&nbsp;/&nbsp;
  									<input type="text" name="epi" size="10" placeholder="에피소드" required/>개
  								</dd>
  								
  								<dt class="col-sm-3">감독</dt>
  								<dd class="col-sm-9"><input type="text" name="director" size="30" placeholder="감독" required/></dd>
  								
  								<dt class="col-sm-3">배우</dt>
  								<dd class="col-sm-9"><input type="text" name="actor" size="30" placeholder="배우" required/></dd>
							
  								<dt class="col-sm-3">장르</dt>
  								<dd class="col-sm-9"><input type="text" name="genre" size="30" placeholder="장르" required/></dd>
								
								<dt class="col-sm-3">줄거리</dt>
								<dd class="col-sm-9"><textarea name="summary" cols="38" rows="10" placeholder="해당 컨텐츠의 줄거리를 입력하세요." required></textarea></dd>
							
								<dt class="col-sm-3">트레일러</dt>
  								<dd class="col-sm-9"><input type="text" name="trailer" size="30" placeholder="트레일러 영상 주소" required/></dd>
							</dl>
			            </div>
			        </div> <!-- 오른쪽 드라마 정보 끝 --> 
			    </div> <!-- class row 끝 -->			
