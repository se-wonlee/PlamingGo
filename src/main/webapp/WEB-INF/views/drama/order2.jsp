		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  			...
  			<div class="carousel-inner">
    			<div class="carousel-item active">
      				<a href="../drama_detailview?c=5">
      					<img src="../resources/upload-drama/Extracurricular2.jpg" class="d-block w-100" 
      					alt="First Slide" width="100%">
      				</a>
    			</div>
    			<div class="carousel-item">
      				<a href="../drama_detailview?c=17">
      					<img src="../resources/upload-drama/stranger-things-season3.jpg" class="d-block w-100" 
      					alt="Second Slide" width="100%">
      				</a>
    			</div>
    			<div class="carousel-item">
      				<a href="../drama_detailview?c=13">
      					<img src="../resources/upload-drama/doctor-poster-season1.jpg" class="d-block w-100" 
					...
					<div class="btn-group" align="center">
						<button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					  	...
					  	<div class="dropdown-menu">
						    <a class="dropdown-item" href="order1">최신작품 순</a>
						    <a class="dropdown-item" href="order2">평균별점 순</a>
						    <a class="dropdown-item" href="order3">조회수 순</a>
			...
			<c:if test="${pageVo.totPage>1 }">
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-center">
				    	...
				    	<li class="page-item">
					      	<a class="page-link" href="?page=${pageVo.totPage }" aria-label="Next">
