...
<table>
	...
	<th rowspan="3" width="100" height="50"><img src="resources/img/qna2.PNG">  </th>
	<th style="color: black" rowspan="3" width="10" height="30">  </th>
	<th style="color: black" colspan="3" width="20">◈　개인정보가 게시되어 노출 될 경우 해당 게시물 작성자가 관련 법령에 따라 <br />　　처분을 받을수 있으니 유의하시기 바랍니다.</th>
	</tr>
	
	<tr>
	<th style="color: black">◈　게시되는 글의 본문이나 첨부파일에 개인정보를 포함시키지 않도록 주의해주시길 바랍니다. <br />　　처분을 받을수 있으니 유의하시기 바랍니다.</th>
	</tr>
</table>
</div>
<br />
<form action="c_write" method="post" enctype="multipart/form-data">
	<table>
		<tr>
			...
			<td> <input type="text" name="qna_id" value="${id }" size="115" readonly="readonly"/> </td>
		</tr>
		<tr>
			<td class="left">제목</td>
			<td> <input type="text" name="qna_title" size="115" /> </td>
		</tr>
		<tr>
			<td class="left">내용</td>
			<td> <textarea name="qna_content" rows="15" cols="115" ></textarea> </td>
		</tr>
		<tr>
			<td class="left">첨부</td>
		...
		<tr>
			<td colspan="2">
			 ...
			 <input type="button" onclick="location.href='http://localhost:9000/PlamingGo/c_list' " value="목록보기" /> 			 
			</td>
		</tr>
