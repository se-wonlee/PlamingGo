...
<br />
<h2 align="center"><strong>공지사항</strong><br /></h2>
<div align="center">
<h6 style="text-shadow: 1px 1px 1px red">공지사항을 확인해주세요 :) !</h6>
</div>
 
<input type="hidden" name="no_num"
 value="${n_contentview.no_num }" />
<table>
	<tr>
		<td class="left">작성자</td>
		<td>
			<input type="text" name="no_id"
			 value="${n_contentview.no_id  }" size="115"/>
		</td>
	</tr>
	<tr>
		<td class="left">제목</td>
		<td>
			<input type="text" name="no_title"
			value="${n_contentview.no_title  }" size="115"/>
		</td>
	<tr>
		<td class="left">내용</td>
		<td>
			<textarea name="no_content" cols="115" rows="22" >
			${n_contentview.no_content  }
			</textarea>
		</td>
	</tr>
	<tr>
		<td class="left">조회수</td>
		<td>${n_contentview.no_hits }</td>
	</tr>
	</tr>
	<tr>
		<td class="left">첨부</td>
		<td>
			<a href="n_download?p=resources/upload/&f=${n_contentview.no_fileSrc }&no_num=${n_contentview.no_num }">
				${n_contentview.no_fileSrc }
			</a>
		</td>
	</tr>
	<tr>
		...
		<input type="button" onclick="location.href='http://localhost:9000/PlamingGo/n_delete?no_num=${n_contentview.no_num }' " value="삭제" /> &nbsp;&nbsp;
		</td> --%>
