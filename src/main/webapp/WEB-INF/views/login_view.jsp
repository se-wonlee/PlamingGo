    ...
    <section id="subscribe">
      <div class="container wow fadeInUp">
        <div class="section-header" style="padding-top: 220px; ">
          ...
          <h2>로그인</h2>
          <p>아직 <strong>PLAMINGGO</strong>  계정이 없다면 <a href="join_terms">여기</a> 를 눌러주세요</p>
        </div>
        ...
        <form method="post" action="login">
          <div class="form-row justify-content-center"  >
            <div class="col-auto">
              <input type="text" class="form-control" placeholder="아이디를 입력해주십시오." name="login_id">
                <c:if test="${log eq 2}">
              <p style="color: red; margin-left: 10px;"><strong>존재하지 않는 아이디입니다.</strong></p>
              </c:if>
              
              <input type="password" class="form-control" placeholder="비밀번호를 입력해주십시오." name="login_pw">
              <c:if test="${log eq 0}">
              <p style="color: red; margin-left: 10px;"><strong>비밀번호가 일치하지 않습니다.</strong></p>
              </c:if>
              <div align="right">
             <a href="find_info_view" style="padding: 0 30px; font-size: 7px; color: white;">아이디 찾기</a>
             <a href="find_info_view" style="padding: 0 30px; font-size: 7px; color: white;">비밀번호 찾기</a>
             </div>
              <button type="submit" style="width: 100%; margin: 10px;" > 로그인 </button>
