...
<br />
<h2 align="center"><strong>문의내용 답변</strong><br /></h2>
<div align="center">
<h6 style="text-shadow: 1px 1px 1px red">문의내용 답변을 확인해주세요 :) !</h6>
</div>
<form action="c_reply" method="post">
<input type="hidden" name="qna_num" value="${c_replyview.qna_num }" />
<input type="hidden" name="qna_group" value="${c_replyview.qna_group }" />
<input type="hidden" name="qna_step" value="${c_replyview.qna_step }" />
<input type="hidden" name="qna_indent" value="${c_replyview.qna_indent }" />

<table>
	<tr>
		<td class="left">조회수</td>
		<td>${c_replyview.qna_hits }</td>
	</tr>
	<tr>
		<td class="left">이름</td>
		<td>
			<input type="text" name="qna_id"
			 value="${c_replyview.qna_id }" size="115" />
		</td>
	</tr>
	<tr>
		<td class="left">제목</td>
		<td>
			...
			value="${c_replyview.qna_title }" size="115"/>
		</td>
	</tr>
	<tr>
		<td class="left">내용</td>
