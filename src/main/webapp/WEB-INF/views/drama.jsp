		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  			...
  			<div class="carousel-inner">
    			<div class="carousel-item">
      				<a href="drama_detailview?c=21">
      					<img src="resources/upload-drama/빨간머리-앤-시즌3.jpg" class="d-block w-100" 
      					alt="Second Slide" width="100%">
      				</a>
    			</div>
    			<div class="carousel-item active">
      				<a href="drama_detailview?c=7">
      					<img src="resources/upload-drama/why-women-kill11.jpg" class="d-block w-100" 
      					alt="First Slide" width="100%">
      				</a>
    			</div>
    			<div class="carousel-item">
      				<a href="drama_detailview?c=12">
      					<img src="resources/upload-drama/the-witcher.jpg" class="d-block w-100" 
					...
					<div class="btn-group" align="center">
						<button type="button" class="btn btn-outline-danger dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					  	...
					  	<div class="dropdown-menu">
						    <a class="dropdown-item" href="drama/order1">최신작품 순</a>
						    <a class="dropdown-item" href="drama/order2">평균별점 순</a>
						    <a class="dropdown-item" href="drama/order3">조회수 순</a>
